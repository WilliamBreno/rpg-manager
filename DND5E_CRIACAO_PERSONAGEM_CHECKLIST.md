...
- ~~Bônus de atributo de raça/antecedente ausente (Seção 0/2)~~ **Respondido: formalizar tanto 2014 quanto 2024.** Ainda não implementado — precisa de uma decisão de arquitetura adicional (como o jogador/mestre escolhe qual das duas regras vale pra um personagem?) antes de codar; ver pergunta em aberto abaixo.
